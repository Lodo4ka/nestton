...
const FastTransactionBanner: React.FC = () => {
  return (
    <div className="flex gap-5 p-5 mt-5 max-w-full text-base font-medium text-red-500 rounded-2xl border border-solid border-rose-500 border-opacity-10 w-[414px]">
...
export default FastTransactionBanner;
